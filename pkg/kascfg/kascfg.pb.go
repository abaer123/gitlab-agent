...
var file_pkg_kascfg_kascfg_proto_rawDesc = []byte{
	...
	0x72, 0x69, 0x6f, 0x64, 0x22, 0xd5, 0x02, 0x0a, 0x0f, 0x4f, 0x62, 0x73, 0x65, 0x72, 0x76, 0x61,
	0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x43, 0x46, 0x12, 0x51, 0x0a, 0x16, 0x75, 0x73, 0x61, 0x67,
	...
	0x69, 0x6f, 0x6e, 0x52, 0x16, 0x75, 0x73, 0x61, 0x67, 0x65, 0x5f, 0x72, 0x65, 0x70, 0x6f, 0x72,
	...
	0x67, 0x43, 0x46, 0x52, 0x07, 0x6c, 0x6f, 0x67, 0x67, 0x69, 0x6e, 0x67, 0x22, 0x72, 0x0a, 0x16,
...
var file_pkg_kascfg_kascfg_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var file_pkg_kascfg_kascfg_proto_goTypes = []interface{}{
	...
	(*ObservabilityCF)(nil),        // 10: kascfg.ObservabilityCF
	(*TokenBucketRateLimitCF)(nil), // 11: kascfg.TokenBucketRateLimitCF
	(*GitalyCF)(nil),               // 12: kascfg.GitalyCF
	(*RedisCF)(nil),                // 13: kascfg.RedisCF
	(*AgentLimitsCF)(nil),          // 14: kascfg.AgentLimitsCF
	(*ConfigurationFile)(nil),      // 15: kascfg.ConfigurationFile
	(*duration.Duration)(nil),      // 16: google.protobuf.Duration
}
var file_pkg_kascfg_kascfg_proto_depIdxs = []int32{
	16, // 0: kascfg.GitopsCF.poll_period:type_name -> google.protobuf.Duration
	16, // 1: kascfg.GitopsCF.project_info_cache_ttl:type_name -> google.protobuf.Duration
	16, // 2: kascfg.GitopsCF.project_info_cache_error_ttl:type_name -> google.protobuf.Duration
	...
	16, // 5: kascfg.AgentCF.info_cache_ttl:type_name -> google.protobuf.Duration
	16, // 6: kascfg.AgentCF.info_cache_error_ttl:type_name -> google.protobuf.Duration
	14, // 7: kascfg.AgentCF.limits:type_name -> kascfg.AgentLimitsCF
	16, // 8: kascfg.AgentConfigurationCF.poll_period:type_name -> google.protobuf.Duration
	16, // 9: kascfg.ObservabilityCF.usage_reporting_period:type_name -> google.protobuf.Duration
	...
	11, // 15: kascfg.GitalyCF.global_api_rate_limit:type_name -> kascfg.TokenBucketRateLimitCF
	11, // 16: kascfg.GitalyCF.per_server_api_rate_limit:type_name -> kascfg.TokenBucketRateLimitCF
	16, // 17: kascfg.RedisCF.read_timeout:type_name -> google.protobuf.Duration
	16, // 18: kascfg.RedisCF.write_timeout:type_name -> google.protobuf.Duration
	16, // 19: kascfg.RedisCF.keepalive:type_name -> google.protobuf.Duration
	0,  // 20: kascfg.ConfigurationFile.listen:type_name -> kascfg.ListenCF
	5,  // 21: kascfg.ConfigurationFile.gitlab:type_name -> kascfg.GitLabCF
	8,  // 22: kascfg.ConfigurationFile.agent:type_name -> kascfg.AgentCF
	10, // 23: kascfg.ConfigurationFile.observability:type_name -> kascfg.ObservabilityCF
	12, // 24: kascfg.ConfigurationFile.gitaly:type_name -> kascfg.GitalyCF
	13, // 25: kascfg.ConfigurationFile.redis:type_name -> kascfg.RedisCF
