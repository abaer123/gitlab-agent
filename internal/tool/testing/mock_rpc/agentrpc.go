...
// Source: gitlab.com/gitlab-org/cluster-integration/gitlab-agent/internal/agentrpc (interfaces: KasClient,Kas_GetObjectsToSynchronizeClient,Kas_GetObjectsToSynchronizeServer,ObjectsToSynchronizeWatcherInterface)
